...
procedure TFColorGame.PlayerTurn(Sender: TObject); //ход игрока
begin
   Turn := Player;
...
procedure TFColorGame.TmrComputerTimer(Sender: TObject);//продолжительность хода
begin
...
procedure TFColorGame.ComputerTurn(Sender: TObject); //ход компьютера
begin
   Turn := Computer;
...
procedure TFColorGame.GameProcess(Sender: TObject); //начало игры
begin
   ComputerTurn(Sender);
end;
